...
const Projects = () => {
  const categories = ["All", "Web Development", "E-commerce", "AI-Powered"];
  ...
  const projects = [
    ...
    },
    {
      ...
      description:
        "Modern e-commerce clothing store for men built with Next.js 15.",
    ...
    },
    {
      ...
      description:
        "A simple and attractive front-end created for Raja's Burgers.",
    ...
    },
    {
      ...
      description:
        "Master humanoid control, embodied intelligence, and VLA systems through our comprehensive engineering guide..",
      link: "https://rajahadi.github.io/-physical-ai-humanoid-robotics-book/",
    },
    {
      title: "File Transformer & Data Cleaner",
      category: "AI-Powered",
      image: "/projects/Growth.png",
      description:
        "Upload your CSV or Excel files to clean, visualize, and convert them.",
      link: "https://growth-mindset-challenge-bbpdjcy3zw2s42nzszgzjq.streamlit.app/",
    },
    {
      title: "Crypto-Assistant-Agent",
      category: "AI-Powered",
      image: "/projects/crypto.png",
      description: "",
      link: "https://crypto-assistant-agent-umrzr6lqrfeadd7jjbb7gp.streamlit.app/",
    },
  ];
    ...
    <section id="projects" className="px-8 py-20 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {filteredProjects.map((item, index) => (
          <div
            key={index}
            className="group relative overflow-hidden rounded-2xl aspect-[4/3] bg-[#2a2a2a]"
          >
            ...
            <div className="absolute inset-0 bg-black/70 opacity-0 group-hover:opacity-100 transition-opacity flex flex-col items-center justify-end pb-8 gap-2 p-6 text-center">
              ...
              <Link href={item.link} target="_blank">
                <button className="bg-primary text-white px-6 py-2 rounded-full mt-2 text-sm cursor-pointer">
                  View Project
                </button>
              </Link>
            </div>

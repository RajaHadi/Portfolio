  ...
  <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
    <div className="lg:w-2/3 md:w-1/2 bg-gray-900 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
      ...
      <div className="bg-gray-900 relative flex flex-wrap py-6 rounded shadow-md">
        <div className="lg:w-1/2 px-6">
          ...
          <p className="mt-1">
            New Haji Camp Road, Sultanabad,Karachi.
          </p>
        </div>
        <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
          ...
          <a href='mailto:rajahr0323@gmail.com' className="text-blue-700 leading-relaxed hover:text-blue-500">rajahr0323@gmail.com</a>
          <h2 className="title-font font-semibold text-white tracking-widest text-xs mt-4">
            PHONE
          </h2>
          <a href='tel:+923307010867' className="leading-relaxed text-blue-700 hover:text-blue-500">03307010867</a>
        </div>
      </div>
    </div>
    <div className="lg:w-1/3 md:w-1/2 flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
     ...
     CONTACT
      ...
      <button className="text-white bg-blue-900 border-0 py-2 px-6 focus:outline-none hover:bg-blue-600 rounded text-lg">
        Send
      </button>
